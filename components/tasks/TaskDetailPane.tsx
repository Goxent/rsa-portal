...
const TaskDetailPane: React.FC<TaskDetailPaneProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex justify-end animate-in fade-in duration-300">
            ...
            {/* Slide-over Pane */}
            <div className="relative w-full max-w-2xl bg-[#0f172a] shadow-2xl border-l border-white/10 flex flex-col h-full animate-in slide-in-from-right duration-500 ease-out">
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto p-8 md:p-10 custom-scrollbar bg-gradient-to-b from-transparent to-black/20">
                    <div className="flex flex-col gap-10 max-w-4xl mx-auto w-full pb-8">
                        ...
                        {/* Details Grid */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#0a0f1d] p-6 rounded-3xl border border-white/5 shadow-2xl">
                ...
                {/* Footer Actions */}
                <div className="px-8 py-6 border-t border-white/10 flex justify-between items-center bg-[#0a0f1d]">
