        ...
        <div className={`relative ${className}`}>
            <button
                ...
                className={`
                    ...
                    hover:bg-white/10 hover:border-white/20 transition-all text-sm text-left
            ...
            {open && (
                <>
                    ...
                    <div className="absolute z-50 w-full mt-2 bg-[#1a1b26] border border-white/10 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-100 p-2">
                        {/* Search Input */}
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`
                                                ...
                                                transition-colors hover:bg-blue-600/20 data-[disabled]:pointer-events-none data-[disabled]:opacity-50
                                                ${isSelected ? 'bg-blue-600/30 text-blue-100' : 'text-gray-300'}
                                            `}
                                        >
                                            ...
                                            {isSelected && <Check className="ml-auto h-4 w-4 text-blue-400" />}
                                        </div>
                                    );
                                })
                            )}
