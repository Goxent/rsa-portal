      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl shadow-2xl border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              required
              className="w-full glass-input rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-amber-500"
          ...
          <div className="pt-4 space-y-3">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-amber-600 hover:bg-amber-500 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-amber-900/40 flex justify-center items-center"
            >
