...
const prefixLines = lines.slice(0, 1271); // 0 to 1270 (line 1271 is 1-indexed)
const suffixLines = lines.slice(1458); // from line 1459 completely down

const finalFileStr = prefixLines.join('\n') + '\n' + newContent + '\n' + suffixLines.join('\n');

fs.writeFileSync('pages/AuditDocumentationPage.tsx', finalFileStr);
console.log('Final complete patch applied.');
